...
namespace Accessibility_backend.Migrations
{
    ...
    [Migration("20240121212527_AccessibilityDB")]
    partial class AccessibilityDB
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accessibility_app.Models.TypeOnderzoek", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Naam = "Onderzoek op locaties"
                        },
                        new
                        {
                            Id = 3,
                            Naam = "websites testen"
                        });
                });
            ...
            modelBuilder.Entity("ChatGebruiker", b =>
                {
                    ...
                    b.HasKey("ChatsId", "GebruikersId");

                    b.HasIndex("GebruikersId");

                    b.ToTable("ChatGebruiker");
                });
            ...
            modelBuilder.Entity("ChatGebruiker", b =>
                {
                    b.HasOne("Accessibility_app.Models.Chat", null)
                        .WithMany()
