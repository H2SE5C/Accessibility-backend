...
namespace Accessibility_backend.Migrations
{
    ...
    [Migration("20231221125310_heledatabase")]
    partial class heledatabase
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Accessibility_app.Models.Medewerker", b =>
                {
                    b.HasOne("Accessibility_app.Models.Chat", "ChatLijst")
                        .WithMany()
                        .HasForeignKey("ChatLijstId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
